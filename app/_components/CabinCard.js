...
function CabinCard({ cabin }) {
  ...
  return (
    <div className="grid grid-cols-1  sm:grid-cols-2 border-primary-800 border">
      ...
      <div className="flex flex-col  relative ">
        <div className="flex flex-col justify-between pt-5 pb-4 px-7 bg-primary-950 h-full">
